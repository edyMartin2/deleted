...
export default {
  ...
  beforeCreate() {
    ...
    if (key) {
      if (key != "") {
        ...
        axios.post(`${this.$store.state.url}/getparquesusuarios`,param).then(res=>{
          let arr = [];
  ...
  methods: {
    ...
    addCorp(){
      ...
      alert(this.datas.id)
      if (this.corp.corp != "" && this.corp.name_es!= "" && this.corp.name_en!= "" && this.corp.rfc!= "" && this.corp.address!= "" && this.corp.cp!= "" && this.corp.colonia!= "" && this.corp.estado!= "" && this.corp.municipio!= "" && this.corp.tel!= "" && this.corp.logo!= ""){
        axios.post(`${this.$store.state.url}/createcorp`,params).then(res=>{alert(res)}).catch(e => console.log(e));
      }else{
